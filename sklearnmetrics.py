...
class score:
    ...
    def calafreq():
        calafreq=random.randrange(72,75)
        return calafreq
    
    def caldfreq():
        caldfreq=random.randrange(70,72)
        return caldfreq
    
    def caljfreq():
        caljfreq=random.randrange(75,78)
        return caljfreq
    
    def calsfreq():
        calsfreq=random.randrange(75,78)
        return calsfreq   

    def caldfereq():
        caldfereq=random.randrange(72,74)
        return caldfereq
