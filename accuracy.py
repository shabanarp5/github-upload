...
print("Joy % : "+str((caljfreq/termjfreq)*100))
print("Anger % : "+str((calafreq/termafreq)*100))
print("Disgust % : "+str((caldfreq/termdfreq)*100))
print("Sad % : "+str((calsfreq/termsfreq)*100))
print("fear % : "+str((caldfereq/termdfereq)*100))